...
import { Ministry, Department, SchemeType, Scheme } from "@/types";
...
export default function EditSchemePage() {
  ...
  useEffect(() => {
    if (profile && !canCreateBudgetProposal(profile)) {
      toast.error("You don't have permission to edit schemes");
  ...
  const fetchScheme = async () => {
    try {
      ...
      setFormData({
        ...
        scheme_type: data.scheme_type || "Central Sector",
